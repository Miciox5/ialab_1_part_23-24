...
commands=(
    ...
    "clingo-dl --parallel-mode=12,split --time-limit=7200 --propagate=full --models=1 --propagate-budget=200,12 --configuration=tweety ${file_name}"
