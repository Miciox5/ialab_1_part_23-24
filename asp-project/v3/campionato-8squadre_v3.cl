...
gioca_a(1,1; % atalanta, citta_bergamo
        ...
        3,3; % inter, citta_milano
        4,4; % juventus, citta_torino_stadium
        5,5; % lazio, citta_lazio_roma
        6,3; % milan, citta_milano
        7,7; % napoli, citta_napoli
        8,8). % roma, citta_roma
